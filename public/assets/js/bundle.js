...
/***/ "./frontend/modules/treinosRegister.js":
/*!*********************************************!*\
  !*** ./frontend/modules/treinosRegister.js ***!
  \*********************************************/
...
/* harmony export */   "default": () => (/* binding */ TreinoRegister)
/* harmony export */ });
...
var TreinoRegister = /*#__PURE__*/function () {
  function TreinoRegister(formClass) {
    _classCallCheck(this, TreinoRegister);
    this.form = document.querySelector(formClass);
  }
  _createClass(TreinoRegister, [{
    key: "init",
    value: function init() {
      this.events();
    }
...
/* harmony import */ var _modules_treinosRegister__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/treinosRegister */ "./frontend/modules/treinosRegister.js");



var treino = new _modules_treinosRegister__WEBPACK_IMPORTED_MODULE_2__["default"]('.form-treino');
document.addEventListener('click', function (e) {
  e.preventDefault();
  alert('teste');
  var clique = e.target;
  if (clique.classList.contains('elementoFilho')) {
    clique.parentNode.remove();
  }
});
})();
